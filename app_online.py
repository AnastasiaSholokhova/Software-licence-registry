...
# Облачное хранилище баз данных
DATABASE_URL = "" #База данных пользователей
DATABASE_URL2 = "" #База данных лицензирования ПО


# Конфигурация для отправки писем на адрес электронной почты
app.config['MAIL_SERVER'] = 'smtp.yandex.ru' #сервер электронной почты - gmail или yandex
